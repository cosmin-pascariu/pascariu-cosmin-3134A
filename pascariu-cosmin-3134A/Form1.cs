...
namespace pascariu_cosmin_3134A
{
    public partial class Form1 : Form
    {
        ...
        private int[,] arrVertex = new int[50, 3]; // stocare matrice de vertexuri. 3 coloane pentru X, Y, Z. Nr. de linii definește nr. de vertexuri.
        private int nVertex;
        ...
        /// <summary>
        /// modificare laborator 9 - punctul 3, event handler-ul btnLight1_Click 
        ...
        /// <summary>
        /// modificare laborator 9 - punctul 3 
        /// Schimbăm culoarea sursei de lumină 1 (ambiental) în domeniul RGB.
        /// </summary>
        ...
        /// <summary>
        /// modificare laborator 9 - punctul 3, resetare stare sursa de lumina nr. 1. (cea de a doua) 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// modificare laborator 9 - punctul 3 
        /// Sursa de lumină va putea fi deplasată folosind(a) 6 taste(3 axe spațiale) 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            // modificare laborator 9 - punctul 3 
            // Sursa de lumină adițională va putea fi deplasată folosind: (b) mouse - ul (2 axe spațiale).
            if (statusControlMouse2D == true)
            {
